...
class Aprovado(Estado_de_um_orcamento):
  ...
  def aprova(self, orcamento):
    raise Exception('Orçamentos já está aprovado')
  
  def reprova(self, orcamento):
    raise Exception('Orçamentos aprovado não podem ser reprovados')
...
class Reprovado(Estado_de_um_orcamento):
  def aplica_desconto_extra(self, orcamento):
    raise Exception('Orçamento reprovado não receberam desconto extra')

  def aprova(self, orcamento):
    raise Exception('Orçamentos reprovado não podem ser aprovados')
  
  def reprova(self, orcamento):
    raise Exception('Orçamentos reprovado não podem ser reprovado novamente')
...
class Finalizado(Estado_de_um_orcamento):
  def aplica_desconto_extra(self, orcamento):
    raise Exception('Orçamento finalizado não receberam desconto extra')
  
  def aprova(self, orcamento):
    raise Exception('Orçamentos já finalizados não poodem ser aprovados novamente')
  
  def reprova(self, orcamento):
    raise Exception('Orçamentos finalizados não podem ser reprovado novamente')
